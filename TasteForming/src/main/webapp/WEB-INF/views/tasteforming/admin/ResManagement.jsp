		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="/tasteforming/admin/adminPage" class="d-block">adminPage</a>
					</div>
				</div>
								...
								<table class="jsgrid-table">
									...
									<tr class="jsgrid-header-row">
										...
										<th
											...
											style="width: 50px;">Res_Name</th>

										<th class="jsgrid-header-cell jsgrid-header-sortable jsgrid-align-center"
											style="width: 50px;">Create_Date</th>
										<th class="jsgrid-header-cell jsgrid-header-sortable jsgrid-align-center"
											style="width: 50px;">UserId</th>
										<th
											class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable"
											style="width: 150px;">Info</th>
										<th
											class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable"
											style="width: 100px;">address</th>
										<th
											class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable"
											style="width: 50px;">Menu</th>
										<th
											class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable"
											style="width: 30px;">Type</th>
										<th
									...
									<tbody>
										...
										<c:forEach items="${restaurant }" var="res" varStatus="loop">
											...
											<tr
												...
												<td class="jsgrid-cell" style="width: 20px;"><c:out
														value="${res.res_No }" /></td>
												<td class="jsgrid-cell jsgrid-align-center"
													style="width: 50px;"><c:out value="${res.res_Name }" /></td>
												<td class="jsgrid-cell jsgrid-align-center"
													style="width: 50px;"> <fmt:formatDate value="${res.create_Date}" pattern="yyyy-MM-dd" /></td>
												<td class="jsgrid-cell jsgrid-align-center"
