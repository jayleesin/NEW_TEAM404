...
<link
	href="https://hangeul.pstatic.net/hangeul_static/css/NanumGoRyeoGeurGgor.css"
	rel="stylesheet">
<script
...
<body>
	<header>
		...
		<nav class="nav">
			<div class="menu_list">
				<a href="">식당신청</a> <a href="">식당관리</a> <a href="">마이페이지</a>
			</div>
		</nav>
	</header>
			...
			<div class="sub-box">
				...
				<div class="my-slider swiper-container">
						...
						<ul class="swiper-wrapper">
							...
							<!-- 여기입니다. -->
							<c:forEach items="${entry.value }" var="restaurant" begin="0" end="10">
								<li class="swiper-slide"><a href=""> <img
										src="${path }/resources/img/탕수육.jpg" alt="">
										<div class="info_box">
											<p>
												<c:out value="${restaurant.res_No}" />
											</p>
											<p>
											...
											<p>
												<fmt:formatDate pattern="yyyy-MM-dd"
													value="${restaurant.create_Date}" />
											</p>
											<p>
												<c:out value="${restaurant.type }" />
											</p>
										</div>
										<div class="star">
